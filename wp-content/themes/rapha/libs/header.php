            ...
            <div class="flex-box flex-box--between flex-box--aligncenter">
                ...
                <div class="navbar--right flex-box flex-box--end">
                    <ul class="nav-menu flex-box">
                        <li><a href="<?php echo APP_ASSETS; ?>" class="nav-link">HOME</a></li>
                        <li><a href="<?php echo APP_ASSETS; ?>" class="nav-link">SERVICE</a></li>
                        <li><a href="<?php echo APP_ASSETS; ?>" class="nav-link">VIEW</a></li>
                        <li><a href="<?php echo APP_ASSETS; ?>" class="nav-link">HELP</a></li>
                    </ul>
